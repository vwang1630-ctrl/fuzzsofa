...
import { getSavedAddresses, saveAddress, getDefaultAddress, type SavedAddress } from "@/lib/address-storage";
    ...
    return (
        <div className="shop-page">
            ...
            <section className="shop-section">
                ...
                {}
                {savedAddresses.length > 0 && <div className="saved-addresses-section">
                    <div className="saved-addresses-list">
                        {savedAddresses.map(addr => <button
                            key={addr.id}
                ...
                {}
                {(useNewAddress || savedAddresses.length === 0) && <div className="shop-input-row">
                    {}
                    <div>
                        <select
                    ...
                    {}
                    {savedAddresses.length > 0 && <div className="save-address-option">
