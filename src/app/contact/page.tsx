    ...
    <section className="relative">
      ...
      <div className="max-w-5xl mx-auto px-6 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            {submitted ? (
              <div className="bg-[#141414] border border-[#E8B4B8]/30 p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">
                    Name
                  </label>
                  <input
                    type="text"
          ...
          <div>
            ...
            <div className="space-y-6">
              <div>
                <p className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase mb-2">Email</p>
                <p className="text-[#F5F0EB]/70">hello@fuzzsofa.com</p>
              </div>
              <div>
                <p className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase mb-2">Workshop</p>
                <p className="text-[#F5F0EB]/70">Shanghai, China</p>
                <p className="text-sm text-[#6B6B6B]">By appointment only</p>
              </div>
              <div>
                <p className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase mb-2">Response Time</p>
                <p className="text-[#F5F0EB]/70">Within 24 hours</p>
              </div>
              <div>
                <p className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase mb-2">Follow Us</p>
            ...
            <div className="mt-12 bg-[#141414] border border-[#222] p-6">
