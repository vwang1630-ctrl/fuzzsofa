        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div>
                <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">First Name</label>
                <input
                  type="text"
                  required
                  value={form.firstName}
                  onChange={(e) => setForm({ ...form, firstName: e.target.value })}
                  className="w-full bg-[#141414] border border-[#222] px-4 py-3 text-[#F5F0EB] text-sm focus:border-[#E8B4B8] focus:outline-none transition-colors"
                />
              </div>
              <div>
                <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Last Name</label>
                <input
                  type="text"
                  required
                  value={form.lastName}
            ...
            <div>
              <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Email</label>
              <input
                type="email"
                required
                value={form.email}
            ...
            <div>
              <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Phone</label>
              <input
                type="tel"
                value={form.phone}
            ...
            <div>
              <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Address</label>
              <input
                type="text"
                required
                value={form.address}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">City</label>
                <input
                  type="text"
                  required
                  value={form.city}
              ...
              <div>
                <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Country</label>
                <input
                  type="text"
                  required
                  value={form.country}
              ...
              <div>
                <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Postal Code</label>
                <input
                  type="text"
            ...
            <div>
              <label className="text-xs text-[#6B6B6B] tracking-[0.1em] uppercase block mb-2">Order Notes</label>
              <textarea
                rows={3}
                value={form.notes}
                onChange={(e) => setForm({ ...form, notes: e.target.value })}
                className="w-full bg-[#141414] border border-[#222] px-4 py-3 text-[#F5F0EB] text-sm focus:border-[#E8B4B8] focus:outline-none transition-colors resize-none"
          ...
          <div>
            <div className="bg-[#141414] border border-[#222] p-6">
                ...
                {items.map((item) => (
                  <div key={item.product.slug} className="flex justify-between text-sm">
                    <div>
                      ...
                      <p className="text-xs text-[#6B6B6B]">{item.materialType} / {item.materialOption} x{item.quantity}</p>
                    </div>
              ...
              <div className="mt-4 space-y-1">
                <p className="text-xs text-[#6B6B6B]"><span className="text-[#E8B4B8]">&#10003;</span> Free White-Glove Delivery</p>
                <p className="text-xs text-[#6B6B6B]"><span className="text-[#E8B4B8]">&#10003;</span> 14-Day Quality Guarantee</p>
                <p className="text-xs text-[#6B6B6B]"><span className="text-[#E8B4B8]">&#10003;</span> Photo & Video Documentation</p>
              </div>
            </div>
          </div>
        </div>
